...
namespace NewName.NewAbpZeroTemplate.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<NewAbpZeroTemplateDbContext>>()
            ...
            new NewAbpZeroTemplateDbContext(builder.Options).Database.EnsureCreated();
        }
