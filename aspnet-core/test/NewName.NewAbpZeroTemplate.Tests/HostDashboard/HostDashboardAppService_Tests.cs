...
using NewName.NewAbpZeroTemplate.MultiTenancy.HostDashboard;
...
namespace NewName.NewAbpZeroTemplate.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(NewAbpZeroTemplateDbContext context, SubscriptionPayment subscriptionPayment)
        {
