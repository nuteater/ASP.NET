...
using NewName.NewAbpZeroTemplate.Web.Public.Startup;
using NewName.NewAbpZeroTemplate.Web.Session;

namespace NewName.NewAbpZeroTemplate.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : NewAbpZeroTemplateViewComponent
    {
