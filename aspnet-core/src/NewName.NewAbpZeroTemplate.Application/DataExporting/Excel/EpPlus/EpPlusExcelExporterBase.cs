...
namespace NewName.NewAbpZeroTemplate.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : NewAbpZeroTemplateServiceBase, ITransientDependency
    {
