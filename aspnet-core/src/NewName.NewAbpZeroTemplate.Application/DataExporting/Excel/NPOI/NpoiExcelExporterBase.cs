...
namespace NewName.NewAbpZeroTemplate.DataExporting.Excel.NPOI
{
    public abstract class NpoiExcelExporterBase : NewAbpZeroTemplateServiceBase, ITransientDependency
    {
