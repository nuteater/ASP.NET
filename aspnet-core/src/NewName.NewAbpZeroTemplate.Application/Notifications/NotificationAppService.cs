...
using Abp.UI;
using NewName.NewAbpZeroTemplate.Notifications.Dto;

namespace NewName.NewAbpZeroTemplate.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : NewAbpZeroTemplateAppServiceBase, INotificationAppService
    {
