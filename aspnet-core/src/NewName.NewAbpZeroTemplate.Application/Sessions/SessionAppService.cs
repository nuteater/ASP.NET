...
{
    public class SessionAppService : NewAbpZeroTemplateAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = NewAbpZeroTemplateConsts.Currency,
                    CurrencySign = NewAbpZeroTemplateConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = NewAbpZeroTemplateConsts.AllowTenantsToChangeEmailSettings,
