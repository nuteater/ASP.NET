...
namespace NewName.NewAbpZeroTemplate.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : NewAbpZeroTemplateAppServiceBase, IDashboardCustomizationAppService
    {
