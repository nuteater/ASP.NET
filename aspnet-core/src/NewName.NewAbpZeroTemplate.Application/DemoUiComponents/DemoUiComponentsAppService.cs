...
using NewName.NewAbpZeroTemplate.DemoUiComponents.Dto;

namespace NewName.NewAbpZeroTemplate.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : NewAbpZeroTemplateAppServiceBase, IDemoUiComponentsAppService
    {
