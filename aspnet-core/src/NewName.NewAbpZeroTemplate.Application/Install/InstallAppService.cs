...
namespace NewName.NewAbpZeroTemplate.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : NewAbpZeroTemplateAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<NewAbpZeroTemplateDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{NewAbpZeroTemplateConsts.ConnectionStringName}", constring);
        }
