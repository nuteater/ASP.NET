...
using NewName.NewAbpZeroTemplate.Auditing.Exporting;
...
using EntityHistoryHelper = NewName.NewAbpZeroTemplate.EntityHistory.EntityHistoryHelper;

namespace NewName.NewAbpZeroTemplate.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : NewAbpZeroTemplateAppServiceBase, IAuditLogAppService
    {
