...
using NewName.NewAbpZeroTemplate.MultiTenancy.Payments.Paypal;
using NewName.NewAbpZeroTemplate.MultiTenancy.Payments.PayPal;
using NewName.NewAbpZeroTemplate.MultiTenancy.Payments.PayPal.Dto;

namespace NewName.NewAbpZeroTemplate.MultiTenancy.Payments
{
    public class PayPalPaymentAppService : NewAbpZeroTemplateAppServiceBase, IPayPalPaymentAppService
    {
