...
using NewName.NewAbpZeroTemplate.MultiTenancy.Payments.Stripe;
...
{
    public class StripePaymentAppService : NewAbpZeroTemplateAppServiceBase, IStripePaymentAppService
    {
