...
using NewName.NewAbpZeroTemplate.Authorization.Permissions;
...
using NewName.NewAbpZeroTemplate.Authorization.Users.Exporting;
...
namespace NewName.NewAbpZeroTemplate.Authorization.Users
{
    ...
    public class UserAppService : NewAbpZeroTemplateAppServiceBase, IUserAppService
    {
