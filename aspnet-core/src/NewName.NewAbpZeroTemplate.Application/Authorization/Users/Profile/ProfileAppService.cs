...
using NewName.NewAbpZeroTemplate.Authorization.Users.Profile.Cache;
...
using NewName.NewAbpZeroTemplate.Gdpr;
...
using NewName.NewAbpZeroTemplate.Timing;

namespace NewName.NewAbpZeroTemplate.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : NewAbpZeroTemplateAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("NewName.NewAbpZeroTemplate",
