...
using NewName.NewAbpZeroTemplate.Controls;
using NewName.NewAbpZeroTemplate.Dto;
using NewName.NewAbpZeroTemplate.Extensions;
using NewName.NewAbpZeroTemplate.Localization;
using NewName.NewAbpZeroTemplate.UI;
using NewName.NewAbpZeroTemplate.UI.Assets;
using NewName.NewAbpZeroTemplate.Views;
using DependencyResolver = NewName.NewAbpZeroTemplate.Core.Dependency.DependencyResolver;
...
namespace NewName.NewAbpZeroTemplate.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "NewAbpZeroTemplate";
