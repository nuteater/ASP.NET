...
namespace MyCompanyName.AbpZeroTemplate.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var subtasks = pages.CreateChildPermission(AppPermissions.Pages_Subtasks, L("Subtasks"));
            subtasks.CreateChildPermission(AppPermissions.Pages_Subtasks_Create, L("CreateNewSubtask"));
            subtasks.CreateChildPermission(AppPermissions.Pages_Subtasks_Edit, L("EditSubtask"));
            subtasks.CreateChildPermission(AppPermissions.Pages_Subtasks_Delete, L("DeleteSubtask"));
