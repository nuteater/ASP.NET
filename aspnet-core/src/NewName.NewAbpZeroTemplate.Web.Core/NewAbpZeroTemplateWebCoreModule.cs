...
using NewName.NewAbpZeroTemplate.Web.Authentication.JwtBearer;
using NewName.NewAbpZeroTemplate.Web.Authentication.TwoFactor;
using NewName.NewAbpZeroTemplate.Web.Chat.SignalR;
using NewName.NewAbpZeroTemplate.Web.Configuration;
using NewName.NewAbpZeroTemplate.Web.DashboardCustomization;

namespace NewName.NewAbpZeroTemplate.Web
{
    [DependsOn(
        typeof(NewAbpZeroTemplateApplicationModule),
        typeof(NewAbpZeroTemplateEntityFrameworkCoreModule),
    ...
    public class NewAbpZeroTemplateWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public NewAbpZeroTemplateWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(NewAbpZeroTemplateApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(NewAbpZeroTemplateWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(NewAbpZeroTemplateWebCoreModule).Assembly);
        }
