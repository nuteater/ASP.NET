...
namespace NewName.NewAbpZeroTemplate.Web.Security.Recaptcha
{
    public class RecaptchaValidator : NewAbpZeroTemplateServiceBase, IRecaptchaValidator, ITransientDependency
    {
