...
namespace NewName.NewAbpZeroTemplate.Core.Base
{
    public abstract class NewAbpZeroTemplateQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected NewAbpZeroTemplateQueryBase(string fieldName,
