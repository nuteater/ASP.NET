...
using NewName.NewAbpZeroTemplate.Core.Base;
using NewName.NewAbpZeroTemplate.Core.Extensions;
using NewName.NewAbpZeroTemplate.Dto;
using NewName.NewAbpZeroTemplate.Types;

namespace NewName.NewAbpZeroTemplate.Queries
{
    public class OrganizationUnitQuery : NewAbpZeroTemplateQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
