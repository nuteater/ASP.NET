...
namespace NewName.NewAbpZeroTemplate.Web.Areas.App.Views.Shared.Themes.Theme2.Components.AppTheme2Brand
{
    public class AppTheme2BrandViewComponent : NewAbpZeroTemplateViewComponent
    {
