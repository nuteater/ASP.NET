...
using NewName.NewAbpZeroTemplate.Web.Areas.App.Models.Roles;
using NewName.NewAbpZeroTemplate.Web.Areas.App.Models.Users;
...
namespace NewName.NewAbpZeroTemplate.Web.Areas.App.Controllers
{
    ...
    public class UsersController : NewAbpZeroTemplateControllerBase
    {
