...
using NewName.NewAbpZeroTemplate.Web.Areas.App.Models.Languages;
...
namespace NewName.NewAbpZeroTemplate.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : NewAbpZeroTemplateControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = NewAbpZeroTemplateConsts.LocalizationSourceName;
            }
