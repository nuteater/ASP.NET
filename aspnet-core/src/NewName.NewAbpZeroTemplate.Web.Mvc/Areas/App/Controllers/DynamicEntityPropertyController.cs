...
using NewName.NewAbpZeroTemplate.Web.Areas.App.Models.DynamicEntityProperty;
...
namespace NewName.NewAbpZeroTemplate.Web.Areas.App.Controllers
{
    ...
    public class DynamicEntityPropertyController : NewAbpZeroTemplateControllerBase
    {
