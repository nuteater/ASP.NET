...
using NewName.NewAbpZeroTemplate.Configuration.Tenants;
...
using NewName.NewAbpZeroTemplate.Web.Areas.App.Models.Settings;
...
namespace NewName.NewAbpZeroTemplate.Web.Areas.App.Controllers
{
    ...
    public class SettingsController : NewAbpZeroTemplateControllerBase
    {
