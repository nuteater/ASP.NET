...
using NewName.NewAbpZeroTemplate.Web.Areas.App.Models.DynamicEntityPropertyValues;
...
namespace NewName.NewAbpZeroTemplate.Web.Areas.App.Controllers
{
    ...
    public class DynamicEntityPropertyValuesController : NewAbpZeroTemplateControllerBase
    {
