...
using NewName.NewAbpZeroTemplate.Configuration.Host;
...
using NewName.NewAbpZeroTemplate.Web.Areas.App.Models.HostSettings;
...
namespace NewName.NewAbpZeroTemplate.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : NewAbpZeroTemplateControllerBase
    {
