...
using NewName.NewAbpZeroTemplate.Schemas;
using NewName.NewAbpZeroTemplate.Web.Chat.SignalR;
using NewName.NewAbpZeroTemplate.Web.Common;
using NewName.NewAbpZeroTemplate.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using NewName.NewAbpZeroTemplate.Web.IdentityServer;
using NewName.NewAbpZeroTemplate.Web.Swagger;
using Stripe;
...
using NewName.NewAbpZeroTemplate.Web.HealthCheck;
using Owl.reCAPTCHA;
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerDoc("v1", new OpenApiInfo() {Title = "NewAbpZeroTemplate API", Version = "v1"});
            ...
            return services.AddAbp<NewAbpZeroTemplateWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "NewAbpZeroTemplate API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("NewName.NewAbpZeroTemplate.Web.wwwroot.swagger.ui.index.html");
