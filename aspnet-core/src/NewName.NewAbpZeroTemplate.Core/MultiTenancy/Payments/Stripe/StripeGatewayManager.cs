...
{
    public class StripeGatewayManager : NewAbpZeroTemplateServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "NewAbpZeroTemplate";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + NewAbpZeroTemplateConsts.Currency;
        }
