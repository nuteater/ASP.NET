...
using NewName.NewAbpZeroTemplate.MultiTenancy.Demo;
...
namespace NewName.NewAbpZeroTemplate.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(NewAbpZeroTemplateConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(NewAbpZeroTemplateConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
