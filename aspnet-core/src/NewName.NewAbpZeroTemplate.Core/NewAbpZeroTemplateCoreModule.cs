...
using NewName.NewAbpZeroTemplate.Authorization.Ldap;
...
using NewName.NewAbpZeroTemplate.DashboardCustomization.Definitions;
using NewName.NewAbpZeroTemplate.Debugging;
using NewName.NewAbpZeroTemplate.DynamicEntityProperties;
using NewName.NewAbpZeroTemplate.Features;
using NewName.NewAbpZeroTemplate.Friendships;
using NewName.NewAbpZeroTemplate.Friendships.Cache;
using NewName.NewAbpZeroTemplate.Localization;
using NewName.NewAbpZeroTemplate.MultiTenancy;
using NewName.NewAbpZeroTemplate.Net.Emailing;
using NewName.NewAbpZeroTemplate.Notifications;
using NewName.NewAbpZeroTemplate.WebHooks;

namespace NewName.NewAbpZeroTemplate
{
    [DependsOn(
        typeof(NewAbpZeroTemplateCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class NewAbpZeroTemplateCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            NewAbpZeroTemplateLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = NewAbpZeroTemplateConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, NewAbpZeroTemplateMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<NewAbpZeroTemplateSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(NewAbpZeroTemplateCoreModule).GetAssembly());
        }
