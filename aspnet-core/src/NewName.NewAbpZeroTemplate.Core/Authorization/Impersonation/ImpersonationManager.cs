...
namespace NewName.NewAbpZeroTemplate.Authorization.Impersonation
{
    public class ImpersonationManager : NewAbpZeroTemplateDomainServiceBase, IImpersonationManager
    {
