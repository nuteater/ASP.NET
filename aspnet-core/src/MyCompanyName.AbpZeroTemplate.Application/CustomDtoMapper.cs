...
using CreateOrEditTaskTypeDto = MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.Dtos.CreateOrEditTaskTypeDto;
using TaskType = MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.TaskType;
using TaskTypeDto = MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.Dtos.TaskTypeDto;
...
namespace MyCompanyName.AbpZeroTemplate
{
    internal static class CustomDtoMapper
    {
        public static void CreateMappings(IMapperConfigurationExpression configuration)
        {
            ...
            configuration.CreateMap<CreateOrEditSubtaskDto, Subtask>().ReverseMap();
            configuration.CreateMap<SubtaskDto, Subtask>().ReverseMap();
