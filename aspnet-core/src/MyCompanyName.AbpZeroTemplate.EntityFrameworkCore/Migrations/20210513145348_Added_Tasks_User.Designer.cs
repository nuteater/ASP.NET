...
namespace MyCompanyName.AbpZeroTemplate.Migrations
{
    ...
    [Migration("20210513145348_Added_Tasks_User")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.TTTasksNameSace.TaskType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.Subtask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.TTTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.TaskHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.TaskPriority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.TaskTopic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.Task_TaskTopic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.Tasks_User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.TTTask", b =>
                {
                    b.HasOne("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.Subtask", "SubtaskFk")
                        .WithMany()
                        .HasForeignKey("SubtaskId");

                    b.HasOne("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.TaskHistory", "TaskHistoryFk")
                        .WithMany()
                        .HasForeignKey("TaskHistoryId");

                    b.HasOne("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.TaskPriority", "TaskPriorityFk")
                        .WithMany()
                        .HasForeignKey("TaskPriorityId");

                    b.HasOne("MyCompanyName.AbpZeroTemplate.TTTasksNameSace.TaskType", "TaskTypeFk")
                        .WithMany()
                        .HasForeignKey("TaskTypeId");

                    b.Navigation("SubtaskFk");
            ...
            modelBuilder.Entity("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.Task_TaskTopic", b =>
                {
                    b.HasOne("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.TTTask", "TTTaskFk")
                        .WithMany()
                        .HasForeignKey("TTTaskId");

                    b.HasOne("MyCompanyName.AbpZeroTemplate.TTTasksNameSpace.TaskTopic", "TaskTopicFk")
                        .WithMany()
