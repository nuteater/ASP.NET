...
using NewName.NewAbpZeroTemplate.Web.Startup.ExternalLoginInfoProviders;
...
namespace NewName.NewAbpZeroTemplate.Web.Startup
{
    ...
    public class NewAbpZeroTemplateWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public NewAbpZeroTemplateWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(NewAbpZeroTemplateWebHostModule).GetAssembly());
        }
