...
{
    public class SubscriptionPaymentRepository : NewAbpZeroTemplateRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<NewAbpZeroTemplateDbContext> dbContextProvider)
